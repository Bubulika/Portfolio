...
import img from '../assets/bubulika.jpg'
    ...
    return (
      <MainDiv>
        <LeftDiv>
          <Image src={img}/>
          <MainInfo>
            <Infos>Name : Gia</Infos>
            <Infos>Surname : Kharabadze</Infos>
            <Infos>Birthday :1996/01/08</Infos>
            <Infos>Number : +995 598797949</Infos>
            <Infos>Email : gia.khar7@gmail.com</Infos>
          </MainInfo>
        </LeftDiv>
        <RightDiv>
          <Title>About Me </Title>
          <Description>
            Hello there! I'm Gia, a skilled and passionate ReactJS and React
            ...
            expertise extends to various web technologies, including <Skill>HTML,
            CSS, Tailwind, Styled-Component, Javascript, Typescript, ReactJS and React Native.</Skill> 
            With a particular affinity for creating
          ...
          <Description>
            Over the course of my 8-month journey in the software development
